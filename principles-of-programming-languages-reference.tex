...
% TODO: explain the use of . and , in Erlang and make sure that it was used correctly in the examples
% TODO: re-order the sections
% TODO: make sure that all the sections are consistent between languages
...
\end{lstlisting}
  ...
  \begin{itemize}
    ...
    \item symbol \ihaskell{\$} is used to avoid parentheses by applying the function to the right % TODO: check how to use the dollar sign
  \end{itemize}
...
\end{lstlisting}
  ...
  \begin{itemize}
    ...
    \item constrained polymorphism: \ihaskell{<name> :: <type class> a => a -> a}
